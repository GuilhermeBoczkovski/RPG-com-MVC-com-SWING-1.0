...
public class TelaBau extends TelaEncontro{
    ...
    public TelaBau(ControladorBau aThis) {
        super("");
        ctrlBau = aThis;
    ...
    public void mostraException(String message) {
